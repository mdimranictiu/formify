...
const FormCanvas = () => {
  ...
  return (
    <div>
      ...
      <Droppable droppableId="FORM_CANVAS">
        {(provided) => (
          <div
            ...
            className="py-10 top-0 left-0 sticky z-40 mb-4 border-dashed border-2 border-gray-300 rounded bg-white"
          >
      ...
      {/* When Droop in a  Existing Fieldsets */}
        ...
        <Droppable droppableId={fieldset.id} key={fieldset.id}>
          {(provided) => (
            <div
              ref={provided.innerRef}
              {...provided.droppableProps}
              onClick={() => handleSelect(fieldset.id)}
              className=" p-4 mb-4  border rounded "
            >
              <h3 className="text-md font-bold mb-2">{fieldset.name}</h3>
                  ...
                  {(provided) => (
                    ...
                    >
                      <div className="flex justify-center  py-2 rounded-sm">
                        <div className="flex flex-col gap-2 items-start w-[80%] mx-[10%]  bg-white rounded-sm p-3 ">
                          ...
                          field?.type === "date" ? (
                            ...
                            <select className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200">
